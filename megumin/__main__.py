...
from megumin import dispatcher, updater, TOKEN, WEBHOOK, SUDO_USERS, OWNER_ID, CERT_PATH, PORT, URL, LOGGER, OWNER_NAME, ALLOW_EXCL
from megumin.modules import ALL_MODULES
from megumin.modules.helper_funcs.chat_status import is_user_admin
from megumin.modules.helper_funcs.misc import paginate_modules
from megumin.modules.connection import connected
from megumin.modules.connection import connect_button
...
for module_name in ALL_MODULES:
    imported_module = importlib.import_module("megumin.modules." + module_name)
...
def send_start(bot, update):
    ...
    keyboard = [[InlineKeyboardButton(text="📁 Help",callback_data="help_back"),InlineKeyboardButton(text="🛡Creator🛡",url="https://t.me/Smart_S54")]]
    ...
    if chat.type != chat.PRIVATE:
        ...
        update.effective_message.reply_text("Contact me in PM to get the list of possible commands.",
                                            reply_markup=InlineKeyboardMarkup(
                                                ...
                                                [InlineKeyboardButton(text="🛡Contact Creator",url="https://t.me/Smart_S54")]]))
        return
