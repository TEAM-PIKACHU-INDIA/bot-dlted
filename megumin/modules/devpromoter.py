...
from megumin import dispatcher, WHITELIST_USERS, SUPPORT_USERS, SUDO_USERS, DEV_USERS, OWNER_ID
from megumin.modules.helper_funcs.chat_status import whitelist_plus, dev_plus
from megumin.modules.helper_funcs.extraction import extract_user
from megumin.modules.log_channel import gloggable

ELEVATED_USERS_FILE = os.path.join(os.getcwd(), 'megumin/elevated_users.json')
