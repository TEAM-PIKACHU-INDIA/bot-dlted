...
from megumin import dispatcher, LOGGER, DEV_USERS, WHITELIST_USERS
from megumin.modules.helper_funcs.chat_status import user_not_admin, user_admin
from megumin.modules.log_channel import loggable
from megumin.modules.sql import reporting_sql as sql
...
def report(bot: Bot, update: Update) -> str:
    ...
    if chat and message.reply_to_message and sql.chat_should_report(chat.id):
        ...
        if user.id == bot.id:
            message.reply_text("You can't report on me Nigga! 😏.")
            return ""
